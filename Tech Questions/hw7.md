...
{"results":[{"gender":"male","name":{"title":"Mr","first":"Charles","last":"Roberts"},"location":{"street":{"number":1259,"name":"Hillside Road"},"city":"Blenheim","state":"West Coast","country":"New Zealand","postcode":48891,"coordinates":{"latitude":"55.5318","longitude":"-56.8945"},"timezone":{"offset":"-5:00","description":"Eastern Time (US & Canada), Bogota, Lima"}},"email":"charles.roberts@example.com","login":{"uuid":"393261f6-8547-4f06-81b7-a2784be857b5","username":"silverkoala689","password":"bang","salt":"HtrE8azG","md5":"5cc5c5e866256cac9ed763bf7570207d","sha1":"fb3fe24129eb6f803adc1a973922ebfa981d488b","sha256":"e190d70f7eb63829fe870c04337655ae0d469e7376c2716cde62fa5e1164a997"},"dob":{"date":"1954-01-26T15:03:23.465Z","age":70},"registered":{"date":"2011-03-23T00:07:41.604Z","age":13},"phone":"(279)-534-6388","cell":"(280)-452-6133","id":{"name":"","value":null},"picture":{"large":"https://randomuser.me/api/portraits/men/50.jpg","medium":"https://randomuser.me/api/portraits/med/men/50.jpg","thumbnail":"https://randomuser.me/api/portraits/thumb/men/50.jpg"},"nat":"NZ"}],"info":{"seed":"195427485d64f8f8","results":1,"page":1,"version":"1.4"}}
```
Response status: 200 OK  
...
{
  "title": "My Test Post",
  "body": "This is a test post created for demonstration purposes.",
  "userId": 1
}
```
Response:
...
```
Response Status:201 Created  
POST https://randomuser.me/api/create
...
```
{
    "name": "Jane Doe",
    "job": "Project Manager",
    "updatedAt": "2025-01-10T01:13:42.582Z"
}
```
Response Status:200 OK
...
```
{
  "error": "Invalid request body. Missing 'body' field."
}
```